...
def build_projector_payload(env, tournament, db_name):
    ...
    def _idle():
        return {
            ...
            'teams': ctrl._pj_teams(tournament, db_name, env=env, player_on_stage=on_stage),
    ...
    return {
        ...
        'wait_phase': ctrl._pj_wait_phase(tournament, env=env),
        'teams': ctrl._pj_teams(tournament, db_name, leading_team_id=leading_team_id, env=env, player_on_stage=on_stage),
