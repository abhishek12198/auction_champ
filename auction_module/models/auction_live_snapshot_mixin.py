...
WATCHED_FIELDS = {
    'auction.team.player': {
        ...
        'name': frozenset(('lb', 'pj', 'bal', 'reg')),
        'tier_id': frozenset(('lb', 'pj', 'bal', 'reg')),
        'icon_player': frozenset(('lb', 'pj', 'bal')),
        'role': frozenset(('lb', 'pj', 'bal', 'reg')),
        'batting_style': frozenset(('lb', 'pj', 'bal', 'reg')),
        'bowling_style': frozenset(('lb', 'pj', 'bal', 'reg')),
        'sl_no': frozenset(('lb', 'pj', 'bal', 'reg')),
        ...
        'dominant_position_id': frozenset(('lb', 'pj', 'bal', 'reg')),
        'secondary_position_ids': frozenset(('lb', 'pj', 'bal', 'reg')),
        'preferred_foot': frozenset(('lb', 'pj', 'bal', 'reg')),
        'work_rate': frozenset(('lb', 'pj', 'bal', 'reg')),
        'playing_style_ids': frozenset(('lb', 'pj', 'bal', 'reg')),
        'strength_ids': frozenset(('lb', 'pj', 'bal', 'reg')),
        'other_attribute_ids': frozenset(('lb', 'pj', 'bal', 'reg')),
    ...
    'auction.tournament': {
        ...
        'tournament_type': frozenset(('lb', 'pj', 'bal', 'reg')),
        'enable_org_id_registration': frozenset(('reg',)),
        'expose_registered_org_id': frozenset(('reg',)),
        'expose_registered_address': frozenset(('reg',)),
    },
    'auction.team': {
...
WATCH_CREATE_UNLINK = {
    'auction.team.player': frozenset(('reg',)),
